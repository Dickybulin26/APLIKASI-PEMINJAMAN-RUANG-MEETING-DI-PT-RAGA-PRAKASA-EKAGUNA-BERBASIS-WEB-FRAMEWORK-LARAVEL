...
<head>
    ...
    <title>Dashboard - Mazer Opeartor Dashboard</title>
    ...
    <style>
        * {
        ...
        #main .page-content .card .card-header.card-number {
            background-image: linear-gradient(45deg, #58C1D7 0%, #3D8FDD 100%);
            color: #fff;
            border-radius: .7rem;
            padding: 0.8rem 1rem;
            text-align: center;
        ...
        #main .page-content .card .card-header.card-number h6 {
            color: #fff;
        }

        #main .page-content .card .card-body .text-count {
